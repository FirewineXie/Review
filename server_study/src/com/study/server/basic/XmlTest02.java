...
import com.study.server.basic.servlet.Entity;
import com.study.server.basic.servlet.Mapping;
import com.study.server.basic.servlet.Servlet;
import com.study.server.basic.servlet.WebContext;
...
public class XmlTest02 {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
       ...
       /* //SAX 解析
        ...
        List<Person>  personList = handler.gePerson();
